# blaze/editor/code_editor.py - Code editor widget with line numbers
...
from blaze.editor.highlighter import PascalHighlighter
...
class CodeEditor(QPlainTextEdit):
    def __init__(self, parent=None):
        ...
        self.highlighter = PascalHighlighter(self.document(), self._theme)
