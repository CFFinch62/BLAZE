# blaze/editor/tab_widget.py - Multi-tab editor widget
...
from blaze.editor.code_editor import CodeEditor
...
class EditorTabWidget(QTabWidget):
    ...
    def new_file(self) -> CodeEditor:
        """Open a blank editor tab labelled 'untitled.pas'."""
        editor = CodeEditor()
        index = self.addTab(editor, "untitled.pas")
