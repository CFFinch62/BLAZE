# blaze/browser/file_browser.py - File browser panel
...
PASCAL_EXTENSIONS = {
    ".pas", ".pp", ".p", ".lpr", ".lpk", ".inc", ".dpr", ".dpk",
}


class PascalFileFilterProxy(QSortFilterProxyModel):
    """Proxy model that optionally hides non-Pascal files."""
    ...
    def filterAcceptsRow(self, source_row, source_parent):
        ...
        return ext.lower() in PASCAL_EXTENSIONS
...
class FileBrowser(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Filter proxy
        self.proxy_model = PascalFileFilterProxy(self)
        self.proxy_model.setSourceModel(self.fs_model)
        self.proxy_model.enabled = bool(self.settings.get("browser", "pascal_filter"))
    ...
    def _create_new_file(self, dir_path: str):
        ...
        name, ok = QInputDialog.getText(self, "New File", "Filename:", text="untitled.pas")
        if ok and name:
            if not any(name.endswith(e) for e in PASCAL_EXTENSIONS):
                name += ".pas"
