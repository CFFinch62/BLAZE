# Pascal Language Reference — BLAZE IDE

A concise reference for the Free Pascal language as used in the BLAZE IDE.
...
## Compiler Directives (fpc)

```pascal
{$mode objfpc}    { ObjFPC mode (OOP enabled) }
...
*Free Pascal documentation: [freepascal.org/docs.html](https://freepascal.org/docs.html)*
