# Pascal Tutorial — BLAZE IDE

This tutorial teaches Pascal programming using the BLAZE IDE. By the end you will understand the fundamental building blocks of Pascal and be able to write, compile, and run your own programs.

---

## Getting Started

Open BLAZE (`./run.sh`). Press **`Ctrl+N`** to create a new file, or open one of the bundled examples from the `examples/` folder using the file browser on the left. Press **`Ctrl+R`** to compile and run at any time.

---

## Lesson 1 — Hello, World!

Every programming journey starts here. Type this into a new file and save it as `hello.pas`:
...
**What you learned:**
- Every Pascal program starts with `program Name;`
...
Pascal is **strongly typed** — every variable has a declared type.
...
- Browse the `examples/` folder in BLAZE for more programs.
- Read the [Pascal Language Reference](LANGUAGE-REFERENCE.md) for a complete keyword listing.
